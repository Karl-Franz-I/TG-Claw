...
#define WHITELIST_CIVILIAN_RANGER	1
#define WHITELIST_PATROL_RANGER		2
#define WHITELIST_VETERAN_RANGER	4
#define WHITELIST_RANGER			(WHITELIST_CIVILIAN_RANGER|WHITELIST_PATROL_RANGER|WHITELIST_VETERAN_RANGER)
